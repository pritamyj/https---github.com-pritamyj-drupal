 ...
 (function($){
        $(window).scroll(function () {
            if ($(this).scrollTop() < 30){
                ...
                $("header .language-switcher-language-url").css({"background-color":"transparent",'z-index':'1',"background-image": "linear-gradient(transparent, transparent)"})
                ...
                $("header .language-switcher-language-url").css({'z-index':'5',"background-color":"transparent","background-image": "linear-gradient(transparent, transparent)" }); 
